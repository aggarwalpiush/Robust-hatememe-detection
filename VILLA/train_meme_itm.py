        ...
        while True:
            for step, batch in enumerate(train_dataloader):
                ...
                if opts.adv_training:
                    ...
                    txt_delta = torch.Tensor(np.random.normal(0.0, 0.001, size=txt_embeds_init.size())).to('cuda')
                    img_delta = torch.Tensor(np.random.normal(0.0, 0.001, size=img_embeds_init.size())).to('cuda')
                    ...
                    for astep in range(opts.adv_steps):
                        ...
                        if "image" in opts.adv_modality:
                            if opts.norm_type == "l2":
                                ...
                                #print("delta_step")
                                #print(img_delta_step)
                                #print("original tensor")
                                #print(img_delta)
                                #print(img_delta.size())
                                #print("====================")
