...
def get_torch_dataloaders(dataset_name,global_path):
    train_dataset = meme_dataset(dataset_name, 'train', TOKENIZER)
    dev_dataset = meme_dataset(dataset_name, 'val', TOKENIZER)
    test_dataset = meme_dataset(dataset_name, 'test', TOKENIZER)
...
#     datasets = ['mami']
    ...
    for dataset_name in datasets:
        ...
        for sub_data in datasets:
            train_dataloader, dev_dataloader, test_dataloader = get_torch_dataloaders(sub_data,global_path)
