...
class HM:
    def __init__(self,dataset, shot, randomNum):
        self.dataset_name = dataset
        self.shot = shot
        self.randomNum = randomNum
        self.train_tuple = get_tuple(self.dataset_name,'train_'+str(self.shot)+'_'+str(self.randomNum), bs=args.batch_size, shuffle=True, drop_last=False)
...
#                     print(logit[0, :].detach())
            ...
            if self.valid_tuple is not None:  # Do Validation
                ...
                if roc_auc > best_roc:
                    best_roc = roc_auc
                    best_acc = acc
                    self.save(self.dataset_name+'_'+str(self.shot)+'_'+str(self.randomNum))
...
def main():
    ...
    hm.load(os.path.join('saved_m',hm.dataset_name+'_'+str(hm.shot)+'_'+str(hm.randomNum)+'.pth'))
