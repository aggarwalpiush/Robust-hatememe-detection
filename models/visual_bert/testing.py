...
#     img_string_attacks = ['No attack','overlay_stripes','random_10','random_1000','shuffle_1','shuffle_point1']
    ...
    list_results = []
    adv_attacks = [None,'spread_1','spread_3','newsprint','s&p','s&p0.4', 'blur_text_5','s&p_text_0.2', 'with_sp_5px', 'without_sp_5px']
#     adv_attacks = [None,'blur_text_5','s&p_text_0.2']
    for i,attack in enumerate(adv_attacks):
        text_attack = attack
#         if attack == 's&p0.4':
#             text_attack = 's&p_0.4'
        ...
        f.write(hm.dataset_name + '\t' + str(attack) + '\t' + 'googleOCR'  + '\t' + 'VisualBert'  + '\t' + str(0.0) + '\t' + str(f1) + '\n')
        print(attack,f1)
    print(list_results)
#     for i, img_attack in enumerate(img_adv_attacks):
#         text_attack = None
#         hm = HM(img_attack,text_attack)
#         print ("init complete")
#         hm.load(os.path.join('saved',hm.dataset_name+'.pth'))
#         acc, f1 = hm.evaluate(hm.test_tuple)
#         list_results.append([img_string_attacks[i],f1])
#         print(img_string_attacks[i],f1)
#     print(list_results)
