...
from modeling.modeling_bertV import BertV
from modeling.modeling_robertaV import RobertaV
from modeling.modeling_albertV import AlbertV
...
class ModelV(nn.Module):
    ...
    """
    def __init__(self, args=args, max_seq_len=200, num_features=args.num_features, tr_name=args.tr):
        super().__init__()
