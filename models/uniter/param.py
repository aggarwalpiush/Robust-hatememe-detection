...
def parse_args():
    ...
    # Data-Type
    parser.add_argument("--tsv", action='store_const', default=True, const=True, help='Whether to use tsv extraction (else lmdb)')
    ...
    parser.add_argument('--batchSize', dest='batch_size', type=int, default=4)
    ...
    parser.add_argument('--model', type=str, default='U', help='Type of Model, X V O U D')
    ...
    # Automate 
    parser.add_argument('--dataset', type=str, default='fb', help='Type of dataset')
    parser.add_argument('--ocr', type=str, default='googleOCR', help='Type of ocr')
    parser.add_argument('--shot', type=int, default=32, help='amount of shots')
    parser.add_argument('--randomNum', type=int, default=1, help='random selection between 1 and 3')
